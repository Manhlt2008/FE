  ...
  return (
    <div className="self-stretch flex flex-row pt-[53px] pb-0 pr-[51px] pl-[83px] items-center justify-between text-center text-base text-gray font-open-sans md:pl-[30px] md:pr-[30px] md:box-border sm:pl-[30px] sm:pr-[30px] sm:box-border">
      ...
      <div className="flex flex-row py-0 pr-[33px] pl-0 items-center justify-end gap-[29px] md:hidden sm:hidden">
        ...
        <div className="rounded-81xl bg-goldenrod overflow-hidden flex flex-row py-[11.5px] px-[31px] items-center justify-center text-c1818 border-t-[3px] border-solid border-c1818 border-r-[3px] border-b-[5px] border-l-[3px] md:hidden">
