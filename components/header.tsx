...
const Header: NextPage = () => {
  return (
    <div className="self-stretch bg-gray-100 flex flex-row pt-[53px] pb-11 pr-[51px] pl-[83px] items-center justify-between text-center text-base text-gray-200 font-open-sans md:pl-[30px] md:pr-[30px] md:box-border sm:pl-[30px] sm:pr-[30px] sm:box-border">
      <img
