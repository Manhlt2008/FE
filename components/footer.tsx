...
const Footer: NextPage = () => {
  return (
    <div className="self-stretch bg-yellowgreen overflow-hidden flex flex-col py-0 px-5 items-center justify-start text-left text-6xl text-c1818 font-open-sans">
